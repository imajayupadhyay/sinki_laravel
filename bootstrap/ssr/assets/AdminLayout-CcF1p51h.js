  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(unref(Link), {
        ...
        class: ["nav-item group flex items-center px-4 py-3 text-sm font-medium rounded-lg transition-all duration-200", isActive("admin.analytics.index") ? "bg-brand-red text-white shadow-lg" : "text-gray-700 hover:bg-gray-100 hover:text-brand-red"]
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
...
const _sfc_main$1 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<header${ssrRenderAttrs(mergeProps({ class: "bg-white shadow-sm border-b border-gray-200 sticky top-0 z-40" }, _attrs))} data-v-3574f0d4><div class="flex items-center justify-between h-16 px-4 lg:px-6" data-v-3574f0d4><div class="flex items-center" data-v-3574f0d4><button class="lg:hidden p-2 rounded-md text-gray-500 hover:text-gray-900 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-brand-red transition-colors duration-200" data-v-3574f0d4><svg class="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-3574f0d4><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h16" data-v-3574f0d4></path></svg></button><div class="ml-2 lg:ml-0" data-v-3574f0d4><h1 class="text-xl font-bold text-gray-900" data-v-3574f0d4>${ssrInterpolate(__props.pageTitle)}</h1>`);
      if (__props.pageSubtitle) {
        _push(`<p class="text-sm text-gray-500" data-v-3574f0d4>${ssrInterpolate(__props.pageSubtitle)}</p>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div></div><div class="flex items-center space-x-4" data-v-3574f0d4><div class="hidden md:block relative" data-v-3574f0d4><div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none" data-v-3574f0d4><svg class="h-5 w-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-3574f0d4><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" data-v-3574f0d4></path></svg></div><input type="text" placeholder="Search..." class="block w-64 pl-10 pr-3 py-2 border border-gray-300 rounded-lg text-sm placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-brand-red focus:border-transparent transition-all duration-200" data-v-3574f0d4></div><div class="relative" data-v-3574f0d4><button class="p-2 rounded-lg text-gray-500 hover:text-gray-900 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-brand-red transition-colors duration-200" data-v-3574f0d4><svg class="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-3574f0d4><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 17h5l-3.5-3.5c-.6-.6-.9-1.3-.9-2.1V7c0-3.9-3.1-7-7-7S1 3.1 1 7v4.4c0 .8-.3 1.5-.9 2.1L0 17h5m10 0v1a3 3 0 11-6 0v-1m10 0H5" data-v-3574f0d4></path></svg><span class="absolute top-1 right-1 inline-block w-2 h-2 bg-red-500 rounded-full" data-v-3574f0d4></span></button>`);
      if (showNotifications.value) {
        _push(`<div class="absolute right-0 mt-2 w-80 bg-white rounded-lg shadow-lg border border-gray-200 z-50" data-v-3574f0d4><div class="p-4 border-b border-gray-200" data-v-3574f0d4><h3 class="text-sm font-semibold text-gray-900" data-v-3574f0d4>Notifications</h3></div><div class="max-h-64 overflow-y-auto" data-v-3574f0d4><div class="p-4 text-center text-gray-500 text-sm" data-v-3574f0d4> No new notifications </div></div></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div><div class="relative" data-v-3574f0d4><button class="flex items-center space-x-2 p-2 rounded-lg text-gray-700 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-brand-red transition-colors duration-200" data-v-3574f0d4><div class="h-8 w-8 bg-brand-red rounded-full flex items-center justify-center" data-v-3574f0d4><span class="text-white text-sm font-semibold" data-v-3574f0d4>A</span></div><span class="hidden md:block text-sm font-medium" data-v-3574f0d4>Admin</span><svg class="h-4 w-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-3574f0d4><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" data-v-3574f0d4></path></svg></button>`);
      if (showProfileMenu.value) {
        _push(`<div class="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg border border-gray-200 z-50" data-v-3574f0d4><div class="p-2" data-v-3574f0d4><div class="px-3 py-2 border-b border-gray-100" data-v-3574f0d4><p class="text-sm font-medium text-gray-900" data-v-3574f0d4>Admin User</p><p class="text-xs text-gray-500" data-v-3574f0d4>${ssrInterpolate(_ctx.$page.props.auth?.user?.email || "admin@sinki.ai")}</p></div><a href="#" class="flex items-center px-3 py-2 text-sm text-gray-700 hover:bg-gray-100 rounded-md transition-colors duration-200" data-v-3574f0d4><svg class="mr-3 h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-3574f0d4><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" data-v-3574f0d4></path></svg> Profile </a>`);
        _push(ssrRenderComponent(unref(Link), {
          href: _ctx.route("admin.settings.index"),
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<svg class="mr-3 h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-3574f0d4${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z" data-v-3574f0d4${_scopeId}></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" data-v-3574f0d4${_scopeId}></path></svg> Settings `);
            } else {
              return [
                (openBlock(), createBlock("svg", {
                  class: "mr-3 h-4 w-4",
        ...
        _push(`<hr class="my-1" data-v-3574f0d4><button class="w-full flex items-center px-3 py-2 text-sm text-red-600 hover:bg-red-50 rounded-md transition-colors duration-200" data-v-3574f0d4><svg class="mr-3 h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-3574f0d4><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1" data-v-3574f0d4></path></svg> Logout </button></div></div>`);
      } else {
        _push(`<!---->`);
      }
...
const Topbar = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-3574f0d4"]]);
const _sfc_main = {
  __name: "AdminLayout",
  __ssrInlineRender: true,
  props: {
