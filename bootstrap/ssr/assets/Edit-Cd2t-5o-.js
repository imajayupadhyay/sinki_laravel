      ...
      _push(ssrRenderComponent(AdminLayout, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<form class="space-y-6" data-v-f8e95629${_scopeId}><div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden" data-v-f8e95629${_scopeId}><div class="px-6 py-4 border-b border-gray-200" data-v-f8e95629${_scopeId}><h2 class="text-lg font-semibold text-gray-900" data-v-f8e95629${_scopeId}>Post Content</h2></div><div class="p-6 space-y-6" data-v-f8e95629${_scopeId}><div data-v-f8e95629${_scopeId}><label for="title" class="block text-sm font-medium text-gray-700 mb-2" data-v-f8e95629${_scopeId}>Title</label><input id="title"${ssrRenderAttr("value", unref(blogForm).title)} type="text" class="${ssrRenderClass([{ "border-red-500": unref(blogForm).errors.title }, "w-full px-4 py-3 text-lg border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-brand-red focus:border-transparent"])}" placeholder="Enter your blog post title..." required data-v-f8e95629${_scopeId}>`);
            if (unref(blogForm).errors.title) {
              _push2(`<div class="text-red-600 text-sm mt-1" data-v-f8e95629${_scopeId}>${ssrInterpolate(unref(blogForm).errors.title)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-f8e95629${_scopeId}><label for="slug" class="block text-sm font-medium text-gray-700 mb-2" data-v-f8e95629${_scopeId}>URL Slug</label><input id="slug"${ssrRenderAttr("value", unref(blogForm).slug)} type="text" class="${ssrRenderClass([{ "border-red-500": unref(blogForm).errors.slug }, "w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-brand-red focus:border-transparent"])}" placeholder="Leave empty to auto-generate from title" data-v-f8e95629${_scopeId}>`);
            if (unref(blogForm).errors.slug) {
              _push2(`<div class="text-red-600 text-sm mt-1" data-v-f8e95629${_scopeId}>${ssrInterpolate(unref(blogForm).errors.slug)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-f8e95629${_scopeId}><label for="content" class="block text-sm font-medium text-gray-700 mb-2" data-v-f8e95629${_scopeId}>Content</label>`);
            ...
            if (unref(blogForm).errors.content) {
              _push2(`<div class="text-red-600 text-sm mt-1" data-v-f8e95629${_scopeId}>${ssrInterpolate(unref(blogForm).errors.content)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<p class="text-xs text-gray-500 mt-2" data-v-f8e95629${_scopeId}> Use the toolbar above to format your content. Click &quot;HTML&quot; to edit the source code directly. </p></div><div data-v-f8e95629${_scopeId}><label for="excerpt" class="block text-sm font-medium text-gray-700 mb-2" data-v-f8e95629${_scopeId}>Excerpt</label><textarea id="excerpt" rows="3" class="${ssrRenderClass([{ "border-red-500": unref(blogForm).errors.excerpt }, "w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-brand-red focus:border-transparent"])}" placeholder="Brief summary of your post (optional)" data-v-f8e95629${_scopeId}>${ssrInterpolate(unref(blogForm).excerpt)}</textarea>`);
            if (unref(blogForm).errors.excerpt) {
              _push2(`<div class="text-red-600 text-sm mt-1" data-v-f8e95629${_scopeId}>${ssrInterpolate(unref(blogForm).errors.excerpt)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div></div><div class="grid grid-cols-1 lg:grid-cols-3 gap-6" data-v-f8e95629${_scopeId}><div class="lg:col-span-2 space-y-6" data-v-f8e95629${_scopeId}><div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden" data-v-f8e95629${_scopeId}><div class="px-6 py-4 border-b border-gray-200" data-v-f8e95629${_scopeId}><h3 class="text-lg font-semibold text-gray-900" data-v-f8e95629${_scopeId}>SEO Settings</h3></div><div class="p-6 space-y-4" data-v-f8e95629${_scopeId}><div data-v-f8e95629${_scopeId}><label for="meta_title" class="block text-sm font-medium text-gray-700 mb-2" data-v-f8e95629${_scopeId}>Meta Title</label><input id="meta_title"${ssrRenderAttr("value", unref(blogForm).meta_title)} type="text" class="${ssrRenderClass([{ "border-red-500": unref(blogForm).errors.meta_title }, "w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-brand-red focus:border-transparent"])}" placeholder="SEO title for search engines" data-v-f8e95629${_scopeId}>`);
            if (unref(blogForm).errors.meta_title) {
              _push2(`<div class="text-red-600 text-sm mt-1" data-v-f8e95629${_scopeId}>${ssrInterpolate(unref(blogForm).errors.meta_title)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-f8e95629${_scopeId}><label for="meta_description" class="block text-sm font-medium text-gray-700 mb-2" data-v-f8e95629${_scopeId}>Meta Description</label><textarea id="meta_description" rows="3" class="${ssrRenderClass([{ "border-red-500": unref(blogForm).errors.meta_description }, "w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-brand-red focus:border-transparent"])}" placeholder="SEO description for search engines (150-160 characters)" data-v-f8e95629${_scopeId}>${ssrInterpolate(unref(blogForm).meta_description)}</textarea>`);
            if (unref(blogForm).errors.meta_description) {
              _push2(`<div class="text-red-600 text-sm mt-1" data-v-f8e95629${_scopeId}>${ssrInterpolate(unref(blogForm).errors.meta_description)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-f8e95629${_scopeId}><label for="meta_keywords" class="block text-sm font-medium text-gray-700 mb-2" data-v-f8e95629${_scopeId}>Meta Keywords</label><input id="meta_keywords"${ssrRenderAttr("value", unref(blogForm).meta_keywords)} type="text" class="${ssrRenderClass([{ "border-red-500": unref(blogForm).errors.meta_keywords }, "w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-brand-red focus:border-transparent"])}" placeholder="keyword1, keyword2, keyword3" data-v-f8e95629${_scopeId}>`);
            if (unref(blogForm).errors.meta_keywords) {
              _push2(`<div class="text-red-600 text-sm mt-1" data-v-f8e95629${_scopeId}>${ssrInterpolate(unref(blogForm).errors.meta_keywords)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div></div></div><div class="space-y-6" data-v-f8e95629${_scopeId}><div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden" data-v-f8e95629${_scopeId}><div class="px-6 py-4 border-b border-gray-200" data-v-f8e95629${_scopeId}><h3 class="text-lg font-semibold text-gray-900" data-v-f8e95629${_scopeId}>Publish Settings</h3></div><div class="p-6 space-y-4" data-v-f8e95629${_scopeId}><div data-v-f8e95629${_scopeId}><label for="status" class="block text-sm font-medium text-gray-700 mb-2" data-v-f8e95629${_scopeId}>Status</label><select id="status" class="${ssrRenderClass([{ "border-red-500": unref(blogForm).errors.status }, "w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-brand-red focus:border-transparent"])}" data-v-f8e95629${_scopeId}><option value="draft" data-v-f8e95629${ssrIncludeBooleanAttr(Array.isArray(unref(blogForm).status) ? ssrLooseContain(unref(blogForm).status, "draft") : ssrLooseEqual(unref(blogForm).status, "draft")) ? " selected" : ""}${_scopeId}>Draft</option><option value="published" data-v-f8e95629${ssrIncludeBooleanAttr(Array.isArray(unref(blogForm).status) ? ssrLooseContain(unref(blogForm).status, "published") : ssrLooseEqual(unref(blogForm).status, "published")) ? " selected" : ""}${_scopeId}>Published</option></select>`);
            if (unref(blogForm).errors.status) {
              _push2(`<div class="text-red-600 text-sm mt-1" data-v-f8e95629${_scopeId}>${ssrInterpolate(unref(blogForm).errors.status)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-f8e95629${_scopeId}><label for="published_at" class="block text-sm font-medium text-gray-700 mb-2" data-v-f8e95629${_scopeId}>Publish Date</label><input id="published_at"${ssrRenderAttr("value", unref(blogForm).published_at)} type="datetime-local" class="${ssrRenderClass([{ "border-red-500": unref(blogForm).errors.published_at }, "w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-brand-red focus:border-transparent"])}" data-v-f8e95629${_scopeId}>`);
            if (unref(blogForm).errors.published_at) {
              _push2(`<div class="text-red-600 text-sm mt-1" data-v-f8e95629${_scopeId}>${ssrInterpolate(unref(blogForm).errors.published_at)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div></div><div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden" data-v-f8e95629${_scopeId}><div class="px-6 py-4 border-b border-gray-200" data-v-f8e95629${_scopeId}><h3 class="text-lg font-semibold text-gray-900" data-v-f8e95629${_scopeId}>Organization</h3></div><div class="p-6 space-y-4" data-v-f8e95629${_scopeId}><div data-v-f8e95629${_scopeId}><label for="category_id" class="block text-sm font-medium text-gray-700 mb-2" data-v-f8e95629${_scopeId}>Category</label><select id="category_id" class="${ssrRenderClass([{ "border-red-500": unref(blogForm).errors.category_id }, "w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-brand-red focus:border-transparent"])}" data-v-f8e95629${_scopeId}><option value="" data-v-f8e95629${ssrIncludeBooleanAttr(Array.isArray(unref(blogForm).category_id) ? ssrLooseContain(unref(blogForm).category_id, "") : ssrLooseEqual(unref(blogForm).category_id, "")) ? " selected" : ""}${_scopeId}>Select a category</option><!--[-->`);
            ssrRenderList(__props.categories, (category) => {
              _push2(`<option${ssrRenderAttr("value", category.id)} data-v-f8e95629${ssrIncludeBooleanAttr(Array.isArray(unref(blogForm).category_id) ? ssrLooseContain(unref(blogForm).category_id, category.id) : ssrLooseEqual(unref(blogForm).category_id, category.id)) ? " selected" : ""}${_scopeId}>${ssrInterpolate(category.name)}</option>`);
            });
            _push2(`<!--]--></select>`);
            if (unref(blogForm).errors.category_id) {
              _push2(`<div class="text-red-600 text-sm mt-1" data-v-f8e95629${_scopeId}>${ssrInterpolate(unref(blogForm).errors.category_id)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-f8e95629${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-2" data-v-f8e95629${_scopeId}>Tags</label><div class="space-y-2 max-h-48 overflow-y-auto border border-gray-300 rounded-md p-3" data-v-f8e95629${_scopeId}><!--[-->`);
            ssrRenderList(__props.tags, (tag) => {
              _push2(`<label class="flex items-center" data-v-f8e95629${_scopeId}><input type="checkbox"${ssrRenderAttr("value", tag.id)}${ssrIncludeBooleanAttr(Array.isArray(unref(blogForm).tags) ? ssrLooseContain(unref(blogForm).tags, tag.id) : unref(blogForm).tags) ? " checked" : ""} class="rounded border-gray-300 text-brand-red focus:border-brand-red focus:ring-brand-red" data-v-f8e95629${_scopeId}><span class="ml-2 text-sm text-gray-700" data-v-f8e95629${_scopeId}>${ssrInterpolate(tag.name)}</span></label>`);
            });
            _push2(`<!--]--></div>`);
            if (unref(blogForm).errors.tags) {
              _push2(`<div class="text-red-600 text-sm mt-1" data-v-f8e95629${_scopeId}>${ssrInterpolate(unref(blogForm).errors.tags)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div>`);
...
const Edit = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-f8e95629"]]);
export {
  Edit as default
};
