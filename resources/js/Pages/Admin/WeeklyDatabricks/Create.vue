<template>
    <AdminLayout
        page-title="Create New Weekly Databricks Article"
        page-subtitle="Write and publish a new weekly Databricks article"
    >
        <Head title="Create Weekly Databricks Article - Admin Dashboard" />
                ...
                <div class="p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <QuillEditor
                            ...
                            placeholder="Start writing your weekly Databricks article content..."
                            height="500px"
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                        <div class="p-6 space-y-3">
                            ...
                            >
                                {{ weeklyDatabricksForm.processing ? 'Creating...' : 'Create Weekly Databricks Article' }}
                            </button>
                            <Link
...
const submitWeeklyDatabricks = () => {
    weeklyDatabricksForm.post(route('admin.weekly-databricks.store'));
};
