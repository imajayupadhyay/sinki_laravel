<template>
    ...
    >
        <Head title="Create Service Page - Admin Dashboard" />
                ...
                <div class="lg:col-span-2 space-y-8">
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200">
                        ...
                        <div class="p-6 space-y-6">
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Descriptions (one per line)</label>
                                <textarea
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-2">Section Image URL</label>
                                    <div class="flex space-x-2">
                                        <input
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200">
                        <div class="px-6 py-4 border-b border-gray-200">
                            ...
                            <p class="text-sm text-gray-600 mt-1">Configure the services grid section title, description, and individual services</p>
                        </div>
                        <div class="p-6 space-y-6">
                            ...
                            <div class="border-t pt-6">
                                ...
                                <div v-if="form.services_data.length === 0" class="text-center py-8 text-gray-500">
                                ...
                                <div v-for="(service, index) in form.services_data" :key="index" class="mb-6 p-4 border border-gray-200 rounded-lg">
                                    ...
                                    <div class="space-y-4">
                                        ...
                                        <div>
                                            <label class="block text-sm font-medium text-gray-700 mb-1">Service Icon (SVG)</label>
                                            <textarea
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200">
                        ...
                        <div class="p-6">
                            <div class="space-y-4">
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-2">CTA Section Title</label>
                                    <input
                                ...
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-2">CTA Section Description</label>
                                    <textarea
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700 mb-2">CTA Background Image</label>
                                        <div class="flex space-x-2">
                                            <input
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200">
                        ...
                        <div class="p-6 space-y-4">
                            ...
                            >
                                {{ processing ? 'Creating...' : 'Create Service Page' }}
                            </button>
                        </div>
                    </div>
...
// Handle descriptions as text that gets converted to array
