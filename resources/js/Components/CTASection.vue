    ...
    <section id="contact" class="cta-section bg-white py-0 pb-20 lg:pb-24 relative overflow-hidden">
        <div class="container-custom max-w-[1920px] mx-auto px-6 sm:px-12 lg:px-24">
            ...
            <div class="cta-card-wrapper px-2 sm:px-4 lg:px-16">
                ...
                <div class="cta-card relative rounded-[20px] sm:rounded-[25px] lg:rounded-[30px] p-8 sm:p-10 md:p-12 lg:p-16 text-center overflow-hidden shadow-lg min-h-[400px] sm:min-h-[450px] lg:min-h-[500px]">
                    <!-- Background Image -->
                    <div class="absolute inset-0 z-0">
                        <img src="/images/heroobannersinki.png"
                             alt="Background"
                    ...
                    <div class="relative z-10 max-w-[1469px] mx-auto h-full flex flex-col justify-center">
                        <!-- Section Label -->
                        <div class="mb-4 sm:mb-5 md:mb-6 animate-fade-in">
                            <span class="text-brand-dark text-sm sm:text-base md:text-lg font-medium uppercase tracking-[1.2px] sm:tracking-[1.5px] md:tracking-[1.8px]">
                                Let's Get Started
                            </span>
                        </div>

                        <!-- Main Heading -->
                        <h2 class="text-brand-dark font-semibold text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl 2xl:text-[78px] leading-tight sm:leading-tight md:leading-tight lg:leading-[1.1] xl:leading-[1.1] 2xl:leading-[85.8px] mb-4 sm:mb-5 md:mb-6 animate-slide-up px-2 sm:px-4 md:px-6">
                            Ready to Get More from Databricks?
                        </h2>

                        <!-- Description -->
                        <p class="text-brand-dark text-base sm:text-lg md:text-xl lg:text-[22px] xl:text-[24px] leading-relaxed sm:leading-relaxed md:leading-[1.6] lg:leading-[1.5] xl:leading-[36px] mb-8 sm:mb-9 md:mb-10 max-w-[95%] sm:max-w-[90%] md:max-w-[770px] mx-auto animate-slide-up-delayed px-2 sm:px-4">
                        ...
                        <div class="animate-fade-in-up">
                            ...
                            >
                                <span class="whitespace-nowrap">Get Started Now</span>
...
<script setup>
// No script needed for CSS background
</script>
...
/* Ensure content is above effects - but not the background image container */
.cta-card > div.relative {
    position: relative;
}
